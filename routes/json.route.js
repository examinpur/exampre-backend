...
//         const imagePath = imageMap[filename] || imageMap[nameWithoutExt];
//         if (imagePath) {
//           console.log(`Found image ${filename}, mapping path...`);
//           const relativePath = path.relative(path.join(__dirname, ".."), imagePath).replace(/\\/g, "/");
//           questionUrl.push({ url: relativePath, style: img.style || "" });
//         } else {
//           console.warn(`Question image file not found: ${filename}`);
//         }
//       }
...
//           console.log(`Found image ${filename}, mapping path...`);
//           const relativePath = path.relative(path.join(__dirname, ".."), imagePath).replace(/\\/g, "/");
//           solutionUrl.push({ url: relativePath, style: img.style || "" });
//         } else {
//           console.warn(`Solution image file not found: ${filename}`);
//         }
//       }
...
//             const imagePath = imageMap[filename] || imageMap[nameWithoutExt];
//             if (imagePath) {
//               console.log(`Found option image ${filename}, mapping path...`);
//               const relativePath = path.relative(path.join(__dirname, ".."), imagePath).replace(/\\/g, "/");
//               optionImageUrls.push({
//                 url: relativePath,
//                 style: img.style || ''
//               });
//             } else {
//               console.warn(`Option image file not found: ${filename}`);
//             }
//           }
...
//     return res.status(500).json({ message: "Failed to process upload", error: err.message });
//   } finally {
//     console.log("Skipping cleanup. Files will be retained.");
//   }
// });
